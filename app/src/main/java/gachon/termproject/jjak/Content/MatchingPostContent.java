package gachon.termproject.jjak.Content;
...
public class MatchingPostContent {
    ...
    public HashMap<String, RequestContent> requests = new HashMap<>();
    public boolean isRecruited;
    public boolean isMatched;

    public MatchingPostContent() {}

    public MatchingPostContent(String category, String userId, String profileImg, String title, String nickname, String postTime, String postId, String pushToken, String intro, ArrayList<String> location, ArrayList<String> content, ArrayList<String> images, ArrayList<String> locationOfPost, boolean isRecruited, boolean isMatched, HashMap<String, RequestContent> requests) {
    ...
    public HashMap<String, RequestContent> getRequests(){ return requests; }
    ...
    public void setRequests(HashMap<String, RequestContent> requestsList) { this.requests = requests; }
