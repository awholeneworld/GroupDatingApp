...
public class PostContent implements Parcelable {
    ...
    public PostContent(String category, String userId, String profileImg, String title, String nickname, String postTime, String postId, String pushToken, ArrayList<String> content, ArrayList<String> images, String intro, ArrayList<String> location) {
