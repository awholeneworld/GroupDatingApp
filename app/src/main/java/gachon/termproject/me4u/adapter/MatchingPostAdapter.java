...
import gachon.termproject.me4u.activity.MatchingSeePostActivity;
import gachon.termproject.me4u.activity.MatchingWriterSeePostActivity;
...
public class MatchingPostAdapter extends RecyclerView.Adapter<MatchingPostAdapter.ViewHolder>
{
    ...
    public MatchingPostAdapter(Context context, ArrayList<MatchingPostContent> postContentList)
    {
