...
import gachon.termproject.me4u.fragment.ChatFragment;
import gachon.termproject.me4u.fragment.CommunityFragment;
import gachon.termproject.me4u.fragment.HomeFragment;
import gachon.termproject.me4u.fragment.MatchingFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MatchingFragment matchingExpert;
        ...
        switch (n) {
            ...
            case 2:
                if (matchingExpert == null) {
                    matchingExpert = new MatchingFragment();
                ...
                action_bar_title.setText("미팅 구하기");
                actionBar.setDisplayHomeAsUpEnabled(true); //뒤로가기 버튼 생기고 누르면 뒤로감
